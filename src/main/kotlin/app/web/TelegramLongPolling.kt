...
class TelegramLongPolling(
    ...
    private companion object {
        ...
        private val START_GREETING_RU = """
            ...
            ✨ Рецепты — подберу блюдо из ваших продуктов.
            🔍 Калькулятор калорий — посчитаю вашу норму КБЖУ.
            🥗 КБЖУ ингредиента — расскажу о калорийности и составе продукта.
        ...
        private val CALORIE_INPUT_PROMPT = """
            ...
            Обработка запроса может занять время, благодарим за терпение.
