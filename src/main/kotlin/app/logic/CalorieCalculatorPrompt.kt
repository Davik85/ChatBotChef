...
object CalorieCalculatorPrompt {
    ...
    val SYSTEM: String =
        ...
        **Индивидуальный расчёт КБЖУ**
        ...
        В конце обязательно предложи вернутся к созданию рецептов через /recipes.
        Если запрос не по теме, вежливо откажись и предложи вернутся к созданию рецептов через /recipes.
        """.trimIndent()
}
